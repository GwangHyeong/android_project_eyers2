...
public class ScanPwRequest extends StringRequest {

    final static private String URL = "http://eyers1.iwinv.net/UserScanPw.php";
    private Map<String, String> parameters;

    public ScanPwRequest(String user_name, String user_studentnumber,String user_id ,Response.Listener<String> listener) {
