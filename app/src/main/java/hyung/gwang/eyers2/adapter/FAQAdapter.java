...
public class FAQAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<FAQDetailActivity> DataList;
    private LayoutInflater myinf = null;

    public FAQAdapter(Context context, int groupLay, int chlidLay, ArrayList<FAQDetailActivity> DataList){
    ...
    @Override
    public FAQDetailActivity getGroup(int groupPosition) {
        // TODO Auto-generated method stub
